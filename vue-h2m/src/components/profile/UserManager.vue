<template>
  <div class="usermanager">
    <ul v-if="errors && errors.length">
      <li v-for="error of errors" v-bind:key="error.message">{{error.message}}</li>
    </ul>
    <section>
      {{ signupRequest }}
      <b-message
      ...
      >Sorry! Something went wrong. Please try again!</b-message>
      <b-message
        type="is-success"
        v-if="notification.success.length > 0"
      >Thank you! You're successfully registered. Please Login to continue!</b-message>
    </section>
    <div class="field">
...
export default {
  ...
  methods: {
    ...
    isAvailEmail() {
      this.hasEmail = false;
      checkEmailAvailability(this.email.value)
        .then(response => {
